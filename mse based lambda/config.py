...
class Config:
    ...
    s = 10 # true support size
    num_bootstrap = 5 # number of bootstrap samples
    num_mc = 10 # number of Monte Carlo simulations
    alpha_ci = 0.10  # confidence level
    ci_quantiles = [alpha_ci / 2, 1 - alpha_ci / 2]  # [0.05, 0.95]

    # fixed support indices
    # small support for testing purposes where all indicdes < 20
    # support = [5, 6, 8, 8, 9, 10, 11, 12, 13, 14]
